...
//Синхронизация загрузок и прямая передача файлов Linux - Android и Android - Linux
//Вынести настройки в YAML/JSON конфиг
//Прикрутить приватного бота в ТГ, который будет уведомлять о скачивании + дублировать загрузки файлами
